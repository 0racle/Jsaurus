C=_=>{
  ...
  u=location.toString().replace("#","").replace(/^https:\/\/jsaurus\.info\//,"https://jsaurus.info")
...
I=_=>{
  ...
  um.href="https://jsoftware.github.io/j-playground/bin/html2/"
...
W=x=>{F(b.className=x?x:"wbg"[1+"wb".indexOf(b.className)]);um.href="https://jsoftware.github.io/j-playground/bin/html2/"}
X=_=>F(Q(q.value=""))
